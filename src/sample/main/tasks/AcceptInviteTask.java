...
public class AcceptInviteTask extends Task<HttpResponse<String>> { //void

    LoginJournal loginJournal;

    public AcceptInviteTask(LoginJournal loginJournal) {
    ...
    protected HttpResponse<String> call() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:8081/private/accept"))
