...
public class DeleteCategoryTask extends Task<HttpResponse<String>> { //void

    CategoryLoginJournal categoryLoginJournal;

    public DeleteCategoryTask(CategoryLoginJournal categoryLoginJournal) {
    ...
    protected HttpResponse<String> call() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:8081/private/deleteCategory"))
